            ...
            resobj.result.push(
                {
                    ...
                    value: FormDataResult[`resultType${matches[0]}`]==="int"? Number(FormDataResult[`resultValue${matches[0]}`]):FormDataResult[`resultValue${matches[0]}`],
                ...
                resobj.predicates.push(
                    {
                        ...
                        value: data[`type${matches[0]}`]==="int"? Number(data[`value${matches[0]}`]):data[`value${matches[0]}`],
